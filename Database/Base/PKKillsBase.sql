-- Host: localhost    Database: ace_shard_pk_kills
-- ------------------------------------------------------
...
--
-- Current Database: `ace_shard_pk_kills`
--

/*!40000 DROP DATABASE IF EXISTS `ace_shard_pk_kills`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ace_shard_pk_kills` /*!40100 DEFAULT CHARACTER SET utf8mb4 */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `ace_shard_pk_kills`;
